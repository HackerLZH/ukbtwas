...
public class SPREDIXCAN extends AbstractMethod{

    public SPREDIXCAN(UKB.Trait trait, String sex, String name) {
    ...
    protected void runScript() {
        for (Integer chr : UKB.chrSet) {
            String cmd = String.format("%s --job-name=%s sh %s/spredixcan.sh %s %s %s %s %s"
